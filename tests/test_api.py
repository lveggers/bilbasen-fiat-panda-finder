...
class TestListingsEndpoints:
    ...
    def test_get_top_listings_with_scores(self, test_client, sample_listings, test_session):
    ...
    def test_get_top_listings_custom_limit(self, test_client, sample_listings, test_session):
