...
class TestListingScorer:
    ...
    def test_score_price_component(self, sample_dataframe):
        ...
        assert (
            result.loc[min_price_idx, "price_score"]
            >= result.loc[max_price_idx, "price_score"]
        )
    ...
    def test_score_year_component(self, sample_dataframe):
        ...
        assert (
            result.loc[max_year_idx, "year_score"]
            >= result.loc[min_year_idx, "year_score"]
        )
    ...
    def test_score_kilometers_component(self, sample_dataframe):
        ...
        assert (
            result.loc[min_km_idx, "kilometers_score"]
            >= result.loc[max_km_idx, "kilometers_score"]
        )
        ...
        df = pd.DataFrame(
            {
                ...
                "condition_score": [
                    ...
                    0.7,
                    -0.1,
                ],  # Negative condition (should be clipped)
            }
        )
